...
#        PROJECT: ALBY-TERMUX        #
#        Author: ALBY                #
#  email: albinpraveen35790@gmailcom #
...
cd ALBY-TERMUX/properties
cp ASCII-Shadow.flf ${PREFIX}/share/figlet

# change dir to home/ALBY-TERMUX
cd $HOME
cd ALBY-TERMUX
...
echo -e "\e[31m[\e[32m14\e[31m]\e[33m Best-of-ALBY-TERMUX\e[m "
...
echo
echo "[*] Applying ALBY-TERMUX Banner " |lolcat -t
sleep 2
echo
